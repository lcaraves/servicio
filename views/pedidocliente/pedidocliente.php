	...
	<div class="container fluid theme-showcase" role="main">
		...
		<br>
	   	...
	   	<ul class="nav nav-tabs" role="tablist">
	   	  ...
	   	  <li role="presentation"><a href="#devolvio" aria-controls="profile" role="tab" data-toggle="tab">Confirmados</a></li>
	   	  <li role="presentation"><a href="#vendio" aria-controls="profile" role="tab" data-toggle="tab">Negativa</a></li>
	   	</ul>
	   	...
	   	<div class="tab-content">
	   	  ...
	   	  <?php 
	   	    ...
	   	    $consultaPedCliST = "SELECT * FROM pedidocliente pc ORDER BY pc.idPedidoCliente DESC LIMIT 100";
	   	        ...
	   	        <thead>
	   	          ...
	   	          <tbody class="buscar1">
	   	            <tr id="<?php echo $row['idPedidoCliente'] ?>">
	   	              ...
	   	              <td id="articulo_<?php echo $row['idPedidoCliente'] ?>"> <?php echo trim($row['articulo_pedido']); ?> </td>
	   	              <td id="fecha_<?php echo $row['idPedidoCliente'] ?>">  </td>
	   	              <td id="estado_<?php echo $row['idPedidoCliente'] ?>"> <?php echo $row['estado_pedido'] ?> </td>
	   	              <td id="nropresupuesto_<?php echo $row['idPedidoCliente'] ?>"> <?php echo trim($row['nropresupuesto_pedido']) ?> </td>
	   	              <td id="fecha_salida_<?php echo $row['idPedidoCliente'] ?>">
	   	                <?php 
